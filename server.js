...
const port = 3000;
const db_uri = "mongodb+srv://aditisharma90983:Project2comp2004@cluster0.61an9lb.mongodb.net/Products?retryWrites=true&w=majority";
...
server.patch("/product/:id", async (request, response) => {
    ...
    patchProduct
    ? request.send("${product.productName} has been edited")
